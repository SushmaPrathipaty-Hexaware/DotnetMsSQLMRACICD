...
using dotnetMsSQLMRACICD.Api.Filters;
using dotnetMsSQLMRACICD.Business.Installer;

namespace dotnetMsSQLMRACICD.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetMsSQLMRACICD API", Version = version + "-" + branch });
        });
