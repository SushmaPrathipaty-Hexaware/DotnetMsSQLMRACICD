using dotnetMsSQLMRACICD.Api.Installer;
using dotnetMsSQLMRACICD.Api.Middleware;
using dotnetMsSQLMRACICD.Data.Repositories;
...
using System;
using dotnetMsSQLMRACICD.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace dotnetMsSQLMRACICD.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetMsSQLMRACICD V1");
        });
